...
import { CalendarRange, ShieldCheck, Plus, Edit, Trash2, X } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex justify-between items-start">
        ...
        <button
          onClick={openAdd}
          className="bg-[#1A4B9F] text-white px-5 py-2.5 rounded-xl font-bold text-sm flex items-center gap-2 shadow-lg shadow-blue-200 hover:shadow-xl transition-all"
        >
      ...
      <div className="bg-white rounded-2xl border border-zinc-100 shadow-sm overflow-hidden">
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-zinc-50">
            {members.length === 0 && (
              <tr><td colSpan={7} className="px-8 py-16 text-center text-zinc-300 text-sm font-medium">Belum ada jadwal member PB. Klik "Tambah Member" untuk mulai.</td></tr>
            )}
            {members.map((m, i) => (
